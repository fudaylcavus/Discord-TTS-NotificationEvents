    ...
    getSettingsPanel() {
        ...
        setTimeout(() => {
            ...
            NeatoLib.Settings.pushElement(NeatoLib.Settings.Elements.createToggleGroup("vcn-toggles", "Settings", [
                { title : "Play notifications", value : "PlayNotifications", setValue : this.settings.PlayNotifications },
                { title : "Display notifications", value : "DisplayNotifications", setValue : this.settings.DisplayNotifications },
        ...
        this.update = setInterval(() => {
            ...
            for(let id in newStates) {
                ...
                if(lastStates[id] == undefined) {
                    ...
                    if(!this.settings.DisplayNotifications) continue;
                    if(user && channel) {
                    ...
                    if(!this.settings.PlayNotifications) continue;
                    if(user && channel) {
